...
@section('content')
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="intro-text">
                        ...
                        <a class="btn btn-eco" href="#">PLACE ORDER</a><br/>
                        <a class="page-scroll" href="#whyUseUs"><i class="fas fa-angle-down"></i></a>
                    </div>
                    <div class="icons">
    ...
    <section class="bg-white py-3" id="whyUseUs">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <h1 class="text-center title">Why use EduConsult<span class="text-danger">O</span>rg.com ?</h1>
                    <hr class="red-hr">
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-lg-4 col-sm-6">
                    <div class="boxes">
                        <strong class="non-icon">100%</strong>
                        <h4>Original Work</h4>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="boxes">
                        <strong class="icon-field"><i class="far fa-clock"></i></strong>
                ...
                <div class="col-lg-4 col-sm-12 consultationediting">
                    <div class="boxes">
                        <strong class="icon-field"><i class="far fa-comments"></i></strong>
            ...
            <div class="row mt-3">
                <div class="col-lg-4 col-sm-6">
                    <div class="boxes">
                        <strong class="icon-field"><i class="fas fa-calculator"></i></strong>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="boxes">
                        <strong class="icon-field"><i class="fas fa-check"></i></strong>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="boxes">
                        <strong class="icon-field"><i class="fas fa-hands-helping"></i></strong>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="subjects slider">
                        <div>
                            <article class="subjects-boxes criminology">
                                ...
                                <a class="btn btn-small btn-order full-width" href="cruise-detailed.html">ORDER NOW</a>
                            </article>
                        </div>
                        <div>
                            <article class="subjects-boxes education">
                                <div class="course-title">
                                    <span>Education</span>
                                </div>
                                <div class="icon-course">
                        ...
                        <div>
                            <article class="subjects-boxes english-literature">
                                <div class="course-title">
                                ...
                                <div class="course-title-inside">English Literature</div>
                                <div class="course-details">
                                    Asian, Australian, European & Global History, Contemporary International Politics
                                </div>
                                <a class="btn btn-small btn-order full-width" href="cruise-detailed.html">ORDER NOW</a>
                            </article>
                        </div>
                        <div>
                            <article class="subjects-boxes finance">
                                <div class="course-title">
                                    <span>Finance</span>
                                </div>
                                <div class="icon-course">
                        ...
                        <div>
                            <article class="subjects-boxes history">
                                <div class="course-title">
                                    <span>History</span>
                                </div>
                                <div class="icon-course">
                                ...
                                <div class="course-title-inside">History</div>
                                <div class="course-details">
                                    Asian, Australian, European & Global History, Contemporary International Politics
                                </div>
                                <a class="btn btn-small btn-order full-width" href="cruise-detailed.html">ORDER NOW</a>
                        ...
                        <div>
                            <article class="subjects-boxes international-relations">
                                <div class="course-title">
                                ...
                                <div class="course-title-inside">International Relations</div>
                                <div class="course-details">
                        ...
                        <div>
                            <article class="subjects-boxes management">
                                <div class="course-title">
                        ...
                        <div>
                            <article class="subjects-boxes marketing">
                                <div class="course-title">
                                    <span>Marketing</span>
                                </div>
                                <div class="icon-course">
                        ...
                        <div>
                            <article class="subjects-boxes politics">
                                <div class="course-title">
                                    <span>Politics</span>
                                </div>
                                <div class="icon-course">
        ...
        <div class="container">
            ...
            <div class="row mb-3">
                <div class="col-lg-4 col-sm-4 contact-boxes">
                    <div class="content">
                        <div class="icon">
                            <i class="fas fa-map-marked blue-color"></i>
                ...
                <div class="col-lg-4 col-sm-4 contact-boxes">
                    <div class="content">
                        ...
                        <a class="btn btn-eco pointer">FAQ</a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-4 contact-boxes">
                    <div class="content">
                        <div class="icon">
                            <i class="far fa-comments blue-color"></i>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Our Office</h4>
                    </div>
