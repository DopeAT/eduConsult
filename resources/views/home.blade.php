            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="intro-text">
                        ...
                        <a class="btn btn-danger font-weight-bold" href="{{ route('order.index') }}">PLACE ORDER</a><br/>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <article class="subjects-boxes bg-dark">
                        ...
                        <a class="btn btn-small btn-order full-width" href="{{ route('order.index') }}">ORDER NOW</a>
                    </article>
                </div>
                <div class="col-sm-4">
